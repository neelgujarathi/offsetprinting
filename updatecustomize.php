<html>
	...
	if ($_GET['id']) {
	 $view = mysqli_query($conn, "select * from customizedesign where id='" . $_GET['id'] . "'") or die(mysqli_error($conn));
	 $row = mysqli_fetch_array($view);
	}
    ?>
        <div class = "container">
            <h1 class = "form-title"> Customize Design Order Form</h1>
        ...
        <form action = "#" method="post" name="myform" enctype="multipart/form-data">
            <div class="main-user-info">
                ...
                <div class="user-input-box">
                    ...
                    <input type = "text" name = "quantity" id ="n" value="<?php echo $row['Quantity']; ?>">
                    </div>

                    <div class="user-input-box">
                    <label>Product Size</label>
                    <select name="optionlist" id ="pz" value="<?php echo $row['ItemSize']; ?>">
								<option value="None" <?php if ($row['ItemSize'] == 'None') {
															echo "selected";
														} ?>>None</option>
								<option value="None" <?php if ($row['ItemSize'] == 'None') {
															echo "selected";
                ...
                <div class="user-input-box">
                    ...
                    <select name="type" id ="pt" value="<?php echo $row['ItemType']; ?>">
								<option value="Non-Terriable" <?php if ($row['ItemType'] == 'Non-Terriable') {
															echo "selected";
														} ?>>Non-Terriable</option>
								<option value="Terriable" <?php if ($row['ItemType'] == 'Terriable') {
															echo "selected";
														} ?>>Terriable</option>
								<option value="Card like ATM" <?php if ($row['ItemType'] == 'Card like ATM') {
															echo "selected";
                ...
                <div class = "gender-details-box">
                    ...
                    <div class="gender-category">
                        ...
                        <input type="radio" name = "fix" id="os" value="Front Back Side" <?php if ($row['PrintingSide'] == 'Front Side') { ?> checked="checked" <?php } ?>>
                ...
                <div class="user-input-box">
                   ...
                   <input type="file" name="did" value="<?php echo $row['Design']; ?>">
                </div>

                <div class="user-input-box">
                    <label>Product Matter</label>
                   <input type="file" name="m" value="<?php echo $row['Matter']; ?>">
                </div>

                <div class="user-input-box">
                    <label>Comment For Design</label>
                    <textarea name = "comment" cols="33" rows="2" value="<?php echo $row['Comment']; ?>" class="nee">  </textarea>
                </div>
...
if (isset($_POST['update'])) {
	...
	$update = mysqli_query($conn, "update customizedesign set
	        Name='" . $name  . "',
			Contact='" . $contact . "',
            Email='" . $email . "',
            Address='" . $address . "',
