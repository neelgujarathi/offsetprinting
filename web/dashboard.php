				...
				<div class="inner_content">
					...
					<!-- /agile_top_w3_grids-->
					 ...
					 <!-- //agile_top_w3_grids-->
                        ...
                        <table class = "table">
 <center> <h2> <strong><u><i>Customer's Registration Information:-</i></u></strong> </h2></center>
 <br>
 <br>
<?php
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><a href="order_update.php?id=<?php echo $id ?>" class="btn btn-blue  waves-effect"> update</a>
								<td><a href="order_delete.php?id=<?php echo $id ?>" class="btn btn-blue  waves-effect"> Delete</a>
								</td>
							</tr>
						<?php } ?>
